...
import pandas as pd
from cif3r.learned_features import load_embeddings, embeddings_to_numpy
from cif3r.protonet import ProtoNet
...
def get_classes(university):
    data_dir = Path(__file__).resolve().parents[0] / "data/interim"
